...
INVALID_ITEMS_EXCLUDED_MSG = 'Invalid items count. Please enter a number.'
INVALID_TOTAL_SESS_MSG = 'Invalid total sessions count. Please enter a number.'
INVALID_EXTRA_CATEGORIES_MSG = 'Extra categories invalid. Please enter a number.'
LANGUAGES_NOT_PROVIDED_MSG = 'Languages list not provided. Please enter languages separated by a comma.'
